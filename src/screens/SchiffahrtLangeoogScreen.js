...
import RectangleAdd from '../components/RectangleAdd';
        ...
        <Container>
          <Paragraph>
            <Text style={styles.textStyle}>
              Die Schiffahrt Langeoog ist die offizielle Fährverbindung der
              Gemeinde Langeoog. Auf den vier modernen und geräumigen Schiffen
              Langeoog I bis IV gelangen Sie in ca. einer Stunde auf die Insel
              Langeoog.
            </Text>
          </Paragraph>
          <Text style={[styles.textStyle, { paddingBottom: 10 }]}>
            Der schiffseigene Kiosk versorgt Sie mit Getränken und kleinen
            Snacks - "Eine Bockwurst und ein Jever bitte."
          </Text>
        ...
        <Container>
          ...
          <Paragraph>
            ...
            <Text style={styles.textStyle}>
              E-Mail:{' '}
              <Autolink
                text="info@langeoog.de"
                linkStyle={{ color: '#3a4c91' }}
              />
            </Text>
            <Autolink
              text="http://www.langeoog.de"
              stripPrefix={false}
              linkStyle={{ color: '#3a4c91' }}
            />
          </Paragraph>
